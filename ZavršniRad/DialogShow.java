...
public class DialogShow extends View {
    ...
    public DialogShow(final Context context) {
        ...
        view = View.inflate(context, R.layout.activity_alert_dialog, null);
        dialog.setContentView(view);
        nevershowagain = (CheckBox) view.findViewById(R.id.checkbox);
        closedialog = (Button) view.findViewById(R.id.btnOk);
